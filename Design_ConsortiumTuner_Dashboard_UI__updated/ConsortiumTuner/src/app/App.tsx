...
export default function App() {
  ...
  // Select circuits above threshold
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <aside className="w-80 border-r border-slate-800 p-6 overflow-y-auto flex-shrink-0">
          ...
          <div className="pt-6 border-t border-slate-800 mt-6">
            <div className="flex justify-between mb-2">
              <label className="text-sm">Selection threshold</label>
              <span className="text-sm text-slate-400">
                {threshold.toFixed(2)}
              </span>
            </div>
            ...
            >
              <Slider.Track className="relative grow rounded-full h-1.5 bg-slate-700">
                <Slider.Range className="absolute rounded-full h-full bg-[#8FD14F]" />
              </Slider.Track>
              <Slider.Thumb className="block w-4 h-4 bg-[#8FD14F] rounded-full shadow-lg hover:shadow-xl transition-shadow" />
            </Slider.Root>
          </div>
            ...
            <section className="bg-slate-900/50 rounded-2xl p-6">
              <h3 className="text-lg mb-4">Ecosystem summary</h3>
                ...
                <p className="text-xs text-slate-500 mt-6 leading-relaxed">
                  Circuit selection driven by module weights ≥ threshold (
                  {threshold.toFixed(2)}). Dependency closure ensures required
